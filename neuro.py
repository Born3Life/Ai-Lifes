...
PROMPTS = {
    "morning": (
        ...
        "Сейчас утро (9:00). Напиши пост на 500-800 символов на русском: "
        "разбор одной свежей новости или тренда из мира ИИ, "
        "которая появилась за последнюю неделю. "
        "Объясни простыми словами, почему это важно. "
        "Добавь эмодзи. Тон — дружелюбный, понятный новичкам. "
        "Закончи призывом подписаться. Без хештегов."
    ),
    "afternoon": (
        "Ты — автор Telegram-канала «Нейросети для жизни» (Ai Lifes). "
        "Сейчас день (14:00). Напиши пост на 500-800 символов на русском: "
        "подробная инструкция «как сделать Х с помощью нейросети». "
        "Пример: как перевести видео, сделать конспект, сгенерировать картинку "
        "или автоматизировать рутину. Шаги 1-2-3 с пояснениями. "
        "Добавь эмодзи. Тон — практичный, полезный. "
        "Закончи вопросом к аудитории. Без хештегов."
    ),
    "evening": (
        "Ты — автор Telegram-канала «Нейросети для жизни» (Ai Lifes). "
        "Сейчас вечер (20:00). Напиши пост на 500-800 символов на русском: "
        "подборка 3-4 полезных AI-инструментов с кратким описанием каждого, "
        "или разбор интересного AI-кейса/истории. "
