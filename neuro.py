...
PROMPTS = {
    "morning": (
        ...
        "Запрещено: приветствия ('привет', 'доброе утро'), вопросы читателям, "
        "пустая болтовня, общие фразы, вода. "
        "Сразу переходи к сути. Выбери ОДНУ конкретную и свежую новость "
        "из мира ИИ (выход модели, обновление, новый инструмент) "
        "и объясни на пальцах, чем это важно и как влияет на обычного пользователя. "
        "Пример хорошего начала: «Google выпустила Gemini 2.5 Flash — "
        "теперь нейросеть работает в 2 раза быстрее и бесплатно. "
        "Вот что это значит для вас: ...» "
        "Пиши содержательно, закончи мысль. Добавь 1-2 эмодзи. "
        "Закончи призывом подписаться. Без хештегов. "
        "Минимум 400 символов, максимум — сколько нужно, чтобы раскрыть тему."
    ),
    "afternoon": (
        "Ты пишешь пост для Telegram-канала «Нейросети для жизни». "
        "Это НЕ чат, а информационный канал. "
        "Запрещено: приветствия ('привет', 'добрый день'), вопросы читателям, "
        "пустая болтовня, общие фразы, вода. "
        "Сразу переходи к сути. Напиши пошаговую инструкцию "
        "«как сделать конкретную вещь с помощью нейросети»: "
        "например, перевести видео на русский, создать презентацию за 5 минут, "
        "написать письмо, отретушировать фото. Выбери ОДНУ задачу и распиши. "
        "Пример: «Нужно перевести англоязычное видео на русский? "
        "Берём сервис X, вставляем ссылку, выбираем русский — "
        "через 2 минуты готово. Вот как это работает: ...» "
        "Пиши содержательно, закончи мысль. Добавь 1-2 эмодзи. "
        "Закончи коротким вопросом-призывом к действию. Без хештегов. "
        "Минимум 400 символов, максимум — сколько нужно."
    ),
    "evening": (
        "Ты пишешь пост для Telegram-канала «Нейросети для жизни». "
        "Это НЕ чат, а информационный канал. "
        "Запрещено: приветствия ('привет', 'добрый вечер'), "
        "пожелания ('хорошего вечера'), вопросы читателям, "
        "пустая болтовня, общие фразы, вода. "
        "Сразу переходи к сути. Сделай подборку 3-4 конкретных "
        "и полезных AI-инструментов или сервисов. По каждому: название, "
        "одна строка — что делает, одна строка — почему круто. "
        "Пример: «Gamma.app — создаёт презентации из текста за минуту. "
        "Просто пишете тему, выбираете дизайн — готово. » "
        "ИЛИ разбери один интересный кейс использования нейросетей. "
        "Пиши содержательно, закончи мысль. Добавь 1-2 эмодзи. "
        "Закончи призывом подписаться. Без хештегов. "
        "Минимум 400 символов, максимум — сколько нужно."
    ),
